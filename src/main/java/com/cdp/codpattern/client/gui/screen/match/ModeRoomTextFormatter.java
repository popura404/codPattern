...
public final class ModeRoomTextFormatter {
    ...
    public static String teamScoreText(Map<String, Integer> teamScores) {
        int kortacScore = teamScores.getOrDefault(LEGACY_KORTAC_TEAM, 0);
        int specgruScore = teamScores.getOrDefault(LEGACY_SPECGRU_TEAM, 0);
    ...
    public static String teamSplitText(Map<String, Integer> teamPlayerCounts) {
        int kortacCount = teamPlayerCounts.getOrDefault(LEGACY_KORTAC_TEAM, 0);
        int specgruCount = teamPlayerCounts.getOrDefault(LEGACY_SPECGRU_TEAM, 0);
    ...
    private static String translatedPhaseText(String state) {
        ...
        return Component.translatable("screen.codpattern.room.phase." + normalized).getString();
    }
}
