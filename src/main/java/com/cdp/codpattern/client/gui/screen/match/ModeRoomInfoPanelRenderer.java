...
public final class ModeRoomInfoPanelRenderer {
    ...
    private ModeRoomInfoPanelRenderer() {
    }
    ...
    public static void render(
        ...
        ModeRoomData currentRoomSummary = joinedRoom == null ? null : lobbySummaryState.rooms().get(joinedRoom);
        ModeRoomData selectedPreview = selectedRoomPreviewState.summarySnapshot();
        boolean showSelectedPreview = selectedPreview != null
                && selectedRoom != null
                && !selectedRoom.isBlank()
                && (joinedRoom == null || !selectedRoom.equals(joinedRoom));
        ModeRoomData activeRoomSummary = showSelectedPreview ? selectedPreview : currentRoomSummary;
        ...
        if (activeRoomSummary != null) {
            ...
            if (!metrics.isEmpty()) {
                ...
                for (int i = 0; i < metricCount; i++) {
                    GuiTextHelper.drawReferenceString(
                            graphics,
                            mc.font,
                            ModeRoomTextFormatter.metricText(metrics.get(i)),
                            contentX,
                            infoY,
                ...
                GuiTextHelper.drawReferenceString(
                        ...
                        Component.translatable(
                                "screen.codpattern.room.current_score",
                                ModeRoomTextFormatter.teamScoreText(teamScores)),
                        contentX,
                        infoY,
                        scaleAlpha(0xFFE5E5E5, contentFactor),
                        false);
            ...
            GuiTextHelper.drawReferenceString(
                    ...
                    mc.font,
                    Component.translatable(
                            "screen.codpattern.room.current_phase",
                            ModeRoomTextFormatter.phaseStatusText(
                                    phase,
                                    remainingTimeTicks)),
                    contentX,
                    infoY,
            ...
            if (!showSelectedPreview && joinedRoomLiveState.isStale(nowMs)) {
                GuiTextHelper.drawReferenceString(
                        ...
                        mc.font,
                        Component.translatable(
                                "screen.codpattern.room.live_stale_hint",
            ...
            GuiTextHelper.drawReferenceString(
                    graphics,
                    mc.font,
                    Component.translatable("screen.codpattern.room.loading"),
                    contentX,
                    infoY,
        ...
        ModeRoomData warningRoom = activeRoomSummary;
        if (warningRoom != null
            ...
            GuiTextHelper.drawReferenceString(
                    graphics,
                    mc.font,
                    Component.translatable("screen.codpattern.room.warning_no_end_tp"),
                    contentX,
                    infoY,
                    scaleAlpha(CodTheme.TEXT_DANGER, contentFactor),
                    false);
            GuiTextHelper.drawReferenceString(
                    graphics,
                    mc.font,
                    Component.translatable("screen.codpattern.room.warning_no_end_tp_hint"),
                    contentX,
                    infoY + referenceLineHeight + GuiTextHelper.referenceScaled(3),
        ...
        if (activeRoomSummary != null && rosterTop < rosterBottom) {
            GuiTextHelper.drawReferenceString(
                    graphics,
                    mc.font,
                    Component.translatable("screen.codpattern.room.roster_title"),
                    contentX,
            ...
            if (showSelectedPreview && !selectedRoomPreviewState.hasRosterSnapshot()) {
                GuiTextHelper.drawReferenceString(
                        ...
                        activeRoomSummary.playerCount > 0
                                ? Component.translatable("screen.codpattern.room.roster_loading")
    ...
    private static void renderHeader(
            ...
            int headerY,
            LobbySummaryState lobbySummaryState,
            ModeRoomData activeRoomSummary,
            JoinedRoomLiveState joinedRoomLiveState,
            String joinedRoom,
            String selectedRoom,
        ...
        if (showSelectedPreview && activeRoomSummary != null) {
            GuiTextHelper.drawReferenceEllipsizedString(
                    graphics,
                    mc.font,
                    Component.translatable("screen.codpattern.room.selected_room", activeRoomSummary.mapName),
                    x,
                    headerY,
                    contentWidth,
        ...
        if (joinedRoom != null && (!joinedRoom.isBlank())
            ...
            GuiTextHelper.drawReferenceEllipsizedString(
                    graphics,
                    mc.font,
                    Component.translatable("screen.codpattern.room.current_room", roomLabel(joinedRoom, activeRoomSummary)),
                    x,
                    headerY,
                    contentWidth,
                    scaleAlpha(CodTheme.TEXT_PRIMARY, alphaFactor),
        ...
        Component fallback = lobbySummaryState.isLoading() && !lobbySummaryState.hasLoaded()
                ? Component.translatable("screen.codpattern.room.loading")
                : Component.translatable("screen.codpattern.room.select_hint");
        GuiTextHelper.drawReferenceEllipsizedString(
                graphics,
                mc.font,
                fallback,
    ...
    private static String roomLabel(String roomKey, ModeRoomData summary) {
