...
public class LobbySummaryState {
    private static final long STALE_THRESHOLD_MS = 3000L;

    private Map<String, ModeRoomData> rooms = new HashMap<>();
    ...
    public void applySnapshot(Map<String, ModeRoomData> nextRooms, long nextSnapshotVersion, long nowMs) {
